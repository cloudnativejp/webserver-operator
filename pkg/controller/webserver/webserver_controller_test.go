...
func TestReconcile(t *testing.T) {
	...
	instance := &serversv1beta1.WebServer{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the WebServer object and expect the Reconcile and Deployment to be created
