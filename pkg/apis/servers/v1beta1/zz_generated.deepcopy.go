...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebServerPort) DeepCopyInto(out *WebServerPort) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebServerPort.
func (in *WebServerPort) DeepCopy() *WebServerPort {
	if in == nil {
		return nil
	}
	out := new(WebServerPort)
	in.DeepCopyInto(out)
	return out
}
